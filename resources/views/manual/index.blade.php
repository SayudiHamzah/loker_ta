...
@section('content')
    <section class="content">
        ...
        {{--  <script>
            document.querySelectorAll('input[type="checkbox"][id^="toggleBtnB"]').forEach(function(toggle) {
                toggle.addEventListener('change', function() {
                    const lokerId = this.dataset.id;
                    const userName = this.dataset.userName;
                    console.log("Loker ID:", lokerId); // 🔍 Cek dulu ID-nya di console
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                checkboxes.forEach(function(checkbox) {
                    checkbox.addEventListener('change', function() {
                        ...
                        const newStatus = this.checkedB ? 1 : 0;
                        console.log("Loker masuk di bawah:", lokerId); // 🔍 Cek dulu ID-nya di console

                        fetch(`/loker/update-status/${lockerId}`, {
                                method: 'PUT',
                                headers: {
                                    'Content-Type': 'application/json',
                                    'X-CSRF-TOKEN': '{{ csrf_token() }}'
                            ...
                            .then(data => {
                                // Update label text jika berhasil
                            ...
                            .catch(error => {
                                ...
                                this.checkedB = !this.checkedB; // Revert toggle
                            });
                    });
                });
            });
                        ...
                        if (toggleType === 'cabut') {
                            ...
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    ...
                                    this.checked = true; // Kembalikan toggle ke semula
                                }
                            });
